...
class BertSelfOutput(nn.Module):
    ...
    def forward(self, hidden_states, input_tensor):
        ...
        # print("self.dense.weight.dtype", self.dense.weight.dtype)  # 初始化后检查权重类型
        # print("self.dense.weight", self.dense.weight)  # 查看权重值
        
        # print("self.dense.bias.dtype", self.dense.bias.dtype)  # 初始化后检查权重类型
        # print("self.dense.bias", self.dense.bias)  # 查看权重值
        with torch.cuda.amp.autocast():
            hidden_states = self.dense(hidden_states) # dense的weight太大导致nan
